...
async function updateCartItem(event){
  ...
  if (responseData.updatedCartData.updatedItemPrice === 0) {
    ...
    const cartItemTotalPriceElemet = form.parentElement.querySelector('.cart-item-price');
    cartItemTotalPriceElemet.textContent = responseData.updatedCartData.updatedItemPrice.toFixed(2);
  }
